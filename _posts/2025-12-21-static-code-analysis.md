...
To get started, in this first pass was to just add file headers. StyleCop has a default
...
`SA1600` and other rules. I'll visit the meanings of these rule names/numbers below. 
...
Many of these "rules" are more like just
