...
layout: post
author: Shane Skiles
title: "The Disenshitification Konami Code"
tags: [Google, Disenshitification, Code]
---

Whenever people complain about Google results regarding ads or AI results, I always point them to 
...
no ads, 
no AI summaries, 
no geolocation suggestions,
no contact info... 
just results.
Since it is only organic results, this is an invaluable tool for SEO purposes.
...
Services using the product?
Sometimes I run across ideas in ads that are really clever and make me realize 
...
or bookmark to keep handy. I guess you could probably set that as your default search page 
...
I can never remember "udm", "utm", 14, 15, etc.. You would think "Google disenshitification"
...
There may be other codes that do other things, this was just a list I put 
together experimenting just now. Hopefully, this is another tool you can add to your collection.
